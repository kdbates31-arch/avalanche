    ...
    <div style={styles.app}>
      <main style={styles.screen}>
        <header style={styles.header}>
          ...
          <button style={actionStyle("neutral")} onClick={loadAgents}>Refresh</button>
        </header>
        ...
        {!loading && tab === "mission" && (
          <div style={styles.stack}>
            <div style={styles.tiles}>
              <Tile label="Needs Attention" value={dueNow.length} onClick={() => openDueBucket("All")} accent={TILE_ACCENTS.attention} />
        ...
        {!loading && tab === "contacts" && (
          <div style={styles.stack}>
            <div style={styles.card}>
              <button style={actionStyle("neutral", true)} onClick={resetFilters}>Show All Contacts</button>
...
function EditModal({ form, setForm, updateAgent, saving, close, nextFollowUp, today }) {
  return <div style={styles.overlay}><div style={styles.sheet}><button style={actionStyle("neutral")} onClick={close}>Cancel</button><h2>Edit Contact</h2><ContactForm form={form} setForm={setForm} onSubmit={updateAgent} saving={saving} nextFollowUp={nextFollowUp} today={today} buttonText="Update Contact" /></div></div>;
}
...
const styles = {
  ...
  row: { background: COLORS.innerBg, padding: 12, borderRadius: 16, display: "flex", flexDirection: "column", gap: 4, border: `1px solid ${COLORS.border}` },
  ...
  primary: { width: "100%", padding: 13, borderRadius: 14, fontWeight: 900, border: 0 },
