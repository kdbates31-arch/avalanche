...
export default function App() {
  ...
  async function saveReferralLead(e) {
    ...
    try {
      ...
      await loadReferrals();
      goToTab("mission");
      setMessage("Referral Lead saved to Supabase.");
    } catch (err) {
  ...
  return (
    <div style={styles.app}>
      <main style={styles.screen}>
        ...
        {!loading && tab === "mission" && (
          <div style={styles.stack}>
            ...
            <Section title="Recent Referral Leads" subtitle="Saved customer intake records created from relationship referrals.">
      ...
      {selectedReferral && <ReferralProfile referral={selectedReferral} close={() => setSelectedReferral(null)} edit={() => { setEditingReferral(selectedReferral); setSelectedReferral(null); }} deleteReferral={deleteReferral} />}
...
function ReferralProfile({ referral, close, edit, deleteReferral }) {
  return (
    <div style={styles.overlay}>
      <div style={styles.sheet}>
        <button style={actionStyle("neutral")} onClick={close}>Close</button>
...
function ReferralLeadForm({ form, setForm, agents, populateReferralSource, onSubmit, buttonText }) {
  ...
  return (
    <form style={styles.form} onSubmit={onSubmit}>
      ...
      <Section title="Customer Information" subtitle="Customer details captured from the referral conversation.">
      ...
      <Section title="Property Address" subtitle="Property location for this referral lead.">
