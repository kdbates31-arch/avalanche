...
${body}`,
  ...
  }, [enrichedAgents, search, statusFilter, companyFilter, referralFilter, strengthFilter]);
        ...
        {!loading && tab === "contacts" && (
          <div style={styles.stack}>
            <div style={styles.card}>
              <button style={styles.primary} onClick={() => { setSearch(""); setStatusFilter("All"); setCompanyFilter("All"); setReferralFilter("All"); setStrengthFilter("All"); }}>Show All Contacts</button>
...
function ContactProfile({ agent, logs, close, startEdit, deleteAgent, openCall, emailAndLog, startLog }) {
